...
<!-- start nav -->
	...
	<div class="collapse navbar-collapse" id="ftco-nav">
		<ul id="main_menu" class="navbar-nav m-auto">
			<li class="nav-item"><a href="#" class="nav-link">메뉴소개</a>
				<ul id="sub_menu" >
					 <li><a href="#">샌드위치</a></li>
					 <li><a href="#">랩/기타</a></li>
					 <li><a href="#">찹샐러드</a></li>
            ...
            <li class="nav-item"><a href="#" class="nav-link">이용방법</a>
                 <ul id="sub_menu">
            ...
            <li class="nav-item"><a href="#" class="nav-link">새소식</a>
                 <div>
                 <ul id="sub_menu">
            ...
            <li class="nav-item"><a href="#" class="nav-link">써브웨이</a>
                 <div>
                 <ul id="sub_menu">
            ...
            <li class="nav-item"><a href="#" class="nav-link">가맹정</a>
                 <div>
                 <ul id="sub_menu">
            ...
            <li class="nav-item"><a href="#" class="nav-link">온라인주문</a>
                 <div>
                 <ul id="sub_menu">
